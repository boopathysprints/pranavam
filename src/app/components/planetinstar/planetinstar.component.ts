...
@Component({
  selector: 'app-planetinstar',
  templateUrl: './planetinstar.component.html',
  styleUrls: ['./planetinstar.component.css'],
  providers: [ConfirmationService,MessageService]
})
export class PlanetinstarComponent implements OnInit {
  ...
  constructor(private generalService: GeneralService,private confirmationService: ConfirmationService, private dbService: PlanetinstarService, private messageService: MessageService) { }
  ...
  onRowSelect(event) {
    ...
    this.option2Selected = this.selectedItem.star;
